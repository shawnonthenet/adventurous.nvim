...
local DEFAULT_CONFIG = {
   ...
   colors = require("adventurous.palette"),
   overrides = {},
}
...
---load adventurous colorscheme
local function load()
   if vim.version().minor < 7 then
      vim.notify_once("adventurous.nvim: you must use neovim 0.7 or higher")
      return
   end
